...
const { User, Poke, Category, Order } = require('../models');
...
const resolvers = {
  Query: {
    ...
    pokes: async (parent, { category, name }) => {
      const params = {};
      ...
      return await Poke.find(params).populate('category');
    },
    poke: async (parent, { _id }) => {
      return await Poke.findById(_id).populate('category');
    },
